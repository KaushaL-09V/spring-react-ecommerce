...
public class Product {
    ...
    public Product(int id, String name, String description, String brand, BigDecimal price, Date releaseDate, String category, boolean productAvailable, int stockQuantity) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.brand = brand;
