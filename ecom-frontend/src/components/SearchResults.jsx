...
const SearchResults = () => {
  ...
  // Function to convert base64 string (or URL) to data URL or return a safe fallback
  const convertBase64ToDataURL = (base64String, mimeType = 'image/jpeg') => {
    // If no value provided, return an empty string (img will be empty) — avoids runtime errors
    ...
    // Otherwise assume it's raw base64 and convert to a data URL
            ...
            {searchData.map((product) => (
              <div key={product.id} className="col">
                <div className="card h-100 shadow-sm">
                  <img 
                    src={convertBase64ToDataURL(product.productImage || product.imageData || product.imageUrl || '')} 
